...
general_hyperopt_params='--global_distr 0 --optimise loglik --masked 0 --combined True --losses {lm:none,attention_entropy:none,attention_distance:none} --first_k 20000 --first_k_eval_test 10000 --batch_size 100 --gradient_acc 2 --epochs 1 --early_stop_after 4 --n_trials=100 --eval_interval 20 --n_warmup_steps 2 --use_steps 1 --max_steps none'
hyperopt_selection='--sampler tpe --pruner hyperband --length_weighted 0 --lme_formula RT~length+frequency+surprisal+attention_entropy+attention_distance+(surprisal|WorkerId) --layer_design (0,) --width 4 --depth 4 --n_embd 400 --dropout_attn 0.0 --dropout_resid 0.0;0.6 --dropout_ff 0.0;0.6 --dropout_embd 0.0;0.6 --dropout_lstm 0.0;0.6 --learning_rate 1e-4;1e-2 --d_ff_factor 4;10 --bias 0 --use_dual_fixed 0'
