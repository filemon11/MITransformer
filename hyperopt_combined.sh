...
general_hyperopt_params='--first_k 100 --first_k_eval_test 100 --batch_size 40 --epochs 1 --early_stop_after 4 --n_trials=10 --eval_interval 2 --n_warmup_steps 2 --n_startup_trials 3 --use_steps 1 --max_steps none --optimise perplexity'
