...
general_hyperopt_params='--optimise loglik --masked 0 --first_k 100 --first_k_eval_test 100 --batch_size 40 --epochs 1 --early_stop_after 4 --n_trials=10 --eval_interval 2 --n_warmup_steps 2 --n_startup_trials 3 --use_steps 1 --max_steps none'
hyperopt_selection='--n_embd 200;400 --dropout_attn 0.0 --dropout_resid 0.0;0.6 --dropout_ff 0.0;0.6 --dropout_embd 0.0;0.6 --dropout_lstm 0.0;0.6 --learning_rate 1e-4;1e-2 --d_ff_factor 4;10 --bias 0 --use_dual_fixed 0'
