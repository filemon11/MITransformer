...
general_hyperopt_params='--optimise loglik --masked 0 --combined=True --losses {lm:none,attention_entropy:none,attention_distance:none} --first_k 10000 --first_k_eval_test 10000 --batch_size 100 --gradient_acc 2 --epochs 1 --early_stop_after 4 --n_trials=10 --eval_interval 2 --n_warmup_steps 2 --n_startup_trials 3 --use_steps 1 --max_steps none'
