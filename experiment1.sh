...
general_params="--n_workers ${THREADS_PER_GPU} --device ${DEVICE} --use_ddp ${USE_DDP} --first_k 1 --first_k_eval_test 1"
general_hyperopt_params='--batch_size 1 --epochs 100 --early_stop_after 5 --n_trials=50 --eval_interval 1 --n_warmup_steps 5 --n_startup_trials 5 --use_steps 1 --max_steps none'
