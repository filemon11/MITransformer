...
general_hyperopt_params='--use_amp 0 --batch_size 256 --epochs 5 --early_stop_after 4 --n_trials=500 --eval_interval 2000 --n_warmup_steps 2 --pruner_startup_trials 3 --use_steps 1 --max_steps none --optimise uas --masks_setting current'
