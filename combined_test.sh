...
general_hyperopt_params='--use_lstm False --first_k_eval_test 200 --combined_loss True --distr_mode att-n --global_distr False --length_weighted True --include_current False --batch_size 10 --epochs 100  --early_stop_after none --eval_interval 10 --use_steps 1 --max_steps none --masks_setting current --use_dual_fixed 0'
