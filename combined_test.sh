...
general_hyperopt_params='--first_k_eval_test 20 --combined_loss True --distr_mode att-n --w1 0.33 --w2 0.33 --w3 0.33 --batch_size 20 --epochs 1  --early_stop_after none --eval_interval 20 --use_steps 1 --max_steps none --masks_setting current --use_dual_fixed 0'
