...
hyperopt_selection="--depth 2 --width 2 --losses {lm:0.8,attention_distance:0.1} --n_embd 400 --dropout_attn 0.0 --dropout_resid 0.219 --dropout_ff 0.026 --dropout_embd 0.083 --dropout_lstm 0.305 --learning_rate 1.21e-3 --d_ff_factor 4 --bias 0"
