...
general_hyperopt_params='--masked 0 --use_lstm False --first_k_eval_test 200 --combined_loss True --distr_mode att-n --global_distr False --length_weighted True --include_current False --batch_size 10 --epochs 100  --early_stop_after none --eval_interval 10 --use_steps 1 --max_steps none --masks_setting current --use_dual_fixed 0'
hyperopt_selection="--depth 2 --width 2 --losses {lm:1,attention_entropy:1} --n_embd 400 --dropout_attn 0.0 --dropout_resid 0.219 --dropout_ff 0.026 --dropout_embd 0.083 --dropout_lstm 0.305 --learning_rate 1.21e-3 --d_ff_factor 7 --bias 0"
