...
general_hyperopt_params='--use_amp 0 --batch_size 256 --epochs 10  --early_stop_after none --eval_interval 2000 --use_steps 1 --max_steps none --masks_setting current --use_dual_fixed 0'
