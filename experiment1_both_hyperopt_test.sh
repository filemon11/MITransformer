...
general_hyperopt_params='--batch_size 4 --gradient_acc 32 --epochs 5 --early_stop_after 2 --n_trials=500 --eval_interval 1 --n_warmup_steps 2 --n_startup_trials 3 --use_steps 1 --max_steps none --optimise uas:next:0 --masks_setting both'
hyperopt_selection='--n_embd 200:1000 --dropout_attn 0.0 --dropout_resid 0.0:0.6 --dropout_ff 0.0:0.6 --dropout_embd 0.0:0.6 --dropout_lstm 0.0:0.6 --learning_rate 1e-4:1e-2 --d_ff_factor 4:10 --bias 0 --use_dual_fixed 0 --loss_alpha 0.0:1.0'
